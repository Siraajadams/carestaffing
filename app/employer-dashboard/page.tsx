...
const actions = [
  {
    title: "Post Shift",
    description: "Create a new healthcare shift for locums to apply.",
    href: "/employer",
    icon: "➕",
    color: "#0f766e",
  },
  {
    title: "Manage Shifts",
    description: "View, edit and close your posted shifts.",
    href: "/employer",
    icon: "📋",
    color: "#2563eb",
  },
  {
    title: "Applicants",
    description: "Review locum applications and approve suitable candidates.",
  ...
  },
  {
    ...
    description: "Review hours worked before invoices are generated.",
  ...
  {
    title: "Invoices",
    description: "View invoices, amounts due and payment status.",
  ...
  },
  {
    ...
    description: "Update pharmacy or business owner details.",
    href: "/employer",
    icon: "🏢",
    color: "#475569",
  },
